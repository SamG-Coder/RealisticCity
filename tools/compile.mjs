...
const entries={prepareDistricts:64,generateScene:1,probeOutdoor:1,probeRay:1,probeStreet:1,describeLayout:1,morton:64,sortPairs:64,leaves:64,parents:64,initCamera:1,simulate:1,accumulate:1,farVisibility:64,render:64,temporalResolve:64,rememberFrame:64};
