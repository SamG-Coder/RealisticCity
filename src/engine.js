...
export class BuildingEngine{
 ...
 async init(progress=()=>{}){
  ...
  const names=['prepareDistricts','generateScene','probeOutdoor','probeRay','probeStreet','describeLayout','morton','sortPairs','leaves','parents','initCamera','simulate','accumulate','farVisibility','render','temporalResolve','rememberFrame'];
